...
def commandMotor(x, y, initial_step):
    if scanconfig.cte_verbose:
       print ("Command Motor X: " + str(x) + " Y: " + str(y))
    return sws.commandMotor(x, y, initial_step)
...
scan_ex_id = 2
steps = [ { 'i': (0),'c': (0),'x': (0),'y': (0),'x_coord': (0.0),'y_coord': (0.0),'z_coord': (0.0) },{ 'i': (0),'c': (1),'x': (0),'y': (1),'x_coord': (0.0),'y_coord': (0.0008),'z_coord': (0.0) },{ 'i': (0),'c': (2),'x': (-1),'y': (1),'x_coord': (-0.0018),'y_coord': (0.0008),'z_coord': (0.0) },{ 'i': (0),'c': (3),'x': (-1),'y': (0),'x_coord': (-0.0018),'y_coord': (0.0),'z_coord': (0.0) },{ 'i': (0),'c': (4),'x': (-1),'y': (-1),'x_coord': (-0.0018),'y_coord': (-0.0008),'z_coord': (0.0) },{ 'i': (0),'c': (5),'x': (0),'y': (-1),'x_coord': (0.0),'y_coord': (-0.0008),'z_coord': (0.0) },{ 'i': (0),'c': (6),'x': (1),'y': (-1),'x_coord': (0.0018),'y_coord': (-0.0008),'z_coord': (0.0) },{ 'i': (0),'c': (7),'x': (1),'y': (0),'x_coord': (0.0018),'y_coord': (0.0),'z_coord': (0.0) },{ 'i': (0),'c': (8),'x': (1),'y': (1),'x_coord': (0.0018),'y_coord': (0.0008),'z_coord': (0.0) },{ 'i': (0),'c': (9),'x': (1),'y': (2),'x_coord': (0.0018),'y_coord': (0.0016),'z_coord': (0.0) },{ 'i': (0),'c': (10),'x': (0),'y': (2),'x_coord': (0.0),'y_coord': (0.0016),'z_coord': (0.0) },{ 'i': (0),'c': (11),'x': (-1),'y': (2),'x_coord': (-0.0018),'y_coord': (0.0016),'z_coord': (0.0) },{ 'i': (0),'c': (12),'x': (-2),'y': (2),'x_coord': (-0.0036),'y_coord': (0.0016),'z_coord': (0.0) },{ 'i': (0),'c': (13),'x': (-2),'y': (1),'x_coord': (-0.0036),'y_coord': (0.0008),'z_coord': (0.0) },{ 'i': (0),'c': (14),'x': (-2),'y': (0),'x_coord': (-0.0036),'y_coord': (0.0),'z_coord': (0.0) },{ 'i': (0),'c': (15),'x': (-2),'y': (-1),'x_coord': (-0.0036),'y_coord': (-0.0008),'z_coord': (0.0) },{ 'i': (0),'c': (16),'x': (-2),'y': (-2),'x_coord': (-0.0036),'y_coord': (-0.0016),'z_coord': (0.0) },{ 'i': (0),'c': (17),'x': (-1),'y': (-2),'x_coord': (-0.0018),'y_coord': (-0.0016),'z_coord': (0.0) },{ 'i': (0),'c': (18),'x': (0),'y': (-2),'x_coord': (0.0),'y_coord': (-0.0016),'z_coord': (0.0) },{ 'i': (0),'c': (19),'x': (1),'y': (-2),'x_coord': (0.0018),'y_coord': (-0.0016),'z_coord': (0.0) },{ 'i': (0),'c': (20),'x': (2),'y': (-2),'x_coord': (0.0036),'y_coord': (-0.0016),'z_coord': (0.0) },{ 'i': (0),'c': (21),'x': (2),'y': (-1),'x_coord': (0.0036),'y_coord': (-0.0008),'z_coord': (0.0) },{ 'i': (0),'c': (22),'x': (2),'y': (0),'x_coord': (0.0036),'y_coord': (0.0),'z_coord': (0.0) },{ 'i': (0),'c': (23),'x': (2),'y': (1),'x_coord': (0.0036),'y_coord': (0.0008),'z_coord': (0.0) },{ 'i': (0),'c': (24),'x': (2),'y': (2),'x_coord': (0.0036),'y_coord': (0.0016),'z_coord': (0.0) }, ]
...
while (done != -1) and (curStep < endStep):
    ...
    if (not(cte_use_raw_units)):
        if (cte_z_y_exchange):
            done, mx, my, mcomp = commandMotor(stepXcoord, stepZcoord, curStep == 0)
        else:
            done, mx, my, mcomp = commandMotor(stepXcoord, stepYcoord, curStep == 0)
    else:
        if (cte_z_y_exchange):
